...
const ControlPanel: React.FC<ControlPanelProps> = ({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-card border-t border-gray-200 dark:border-border p-4 shadow-[0_-2px_10px_rgba(0,0,0,0.1)] z-[1000]">
      ...
      {isConverting && (
        <div className="h-1 bg-gray-200 dark:bg-gray-700 rounded overflow-hidden my-4">
          <div
